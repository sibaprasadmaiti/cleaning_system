...
<body class="vertical-layout vertical-menu-modern 1-column blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
                                    ...
                                    <div class="card-body">
                                        <form id="login_form" class="form-horizontal">
                                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                                <input type="email" class="form-control" id="user_name" name="user_name" placeholder="xyz@test.com" required>
                                ...
                                <div class="card-footer">
                                    <div class="">
                                        ...
                                        <p class="float-xl-right text-center m-0">
                                            ...
                                            <a href="<?php echo base_url(); ?>" class="card-link">
                                                Login
                                            </a>
                                        </p>
                                    </div>
    ...
    <!-- <script src="<?php echo base_url(); ?>assets/vendors/js/forms/icheck/icheck.min.js"></script> -->
    <!-- <script src="<?php echo base_url(); ?>assets/vendors/js/forms/validation/jqBootstrapValidation.js"></script> -->
    <!-- END: Page Vendor JS-->
    <!-- BEGIN: Theme JS-->
    ...
    <!-- END: Theme JS-->
    <!-- BEGIN: Page JS-->
    <!-- <script src="<?php echo base_url(); ?>assets/js/scripts/forms/form-login-register.js"></script> -->
    <!-- END: Page JS-->
    ...
    <script>
        ...
        $("#login_form").validate({
            ...
            submitHandler: function(form) {
                $(form).ajaxSubmit({
                    url: "<?php echo base_url('contractor/check_login'); ?>",
                    type: 'post',
                    dataType: 'json',
                    success: function(response) {
                        if (response.status == 'success') {
                            window.location.href="<?php echo base_url('contractor/inspection')?>";
                        } else {
