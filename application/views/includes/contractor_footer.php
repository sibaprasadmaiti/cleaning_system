    <div class="sidenav-overlay"></div>
        ...
        <footer class="footer footer-static footer-light navbar-border navbar-shadow">
            <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block"> Copyright &copy; <?php echo date('Y'); ?> Shubham Sawant</span></p>
        </footer>
...
<script>
    ...
    $("#change_password_frm").validate({
        ...
        submitHandler: function(form) {
            $(form).ajaxSubmit({
                url: "<?php echo base_url('contractor/update_password'); ?>",
                type: 'post',
                dataType: 'json',
                ...
                error: function() {
                    alert('Problem in updating password. Please try again.');
                }
            });
        }
    });
